<template>
    <div>
        <changeImg :getUrl="Url" :getHeight="height"></changeImg>
        <div id="echarts" :style="{width:'830px',height:'650px',margin:'20px auto'}"></div>
    </div>
</template>
                        ...
                        itemStyle: {
                             normal: {
                                ...
                                color: {
                                    ...
                                    r: 0.5,
                                    colorStops: [{
                                        offset: 0, color: color[Math.floor(Math.random()*3)] // 0% 处的颜色
                                    }, {
                                        offset: 1, color: color[Math.floor(Math.random()*3)] // 100% 处的颜色
                                    }],
                                    globalCoord: false // 缺省为 false
                                },
                                borderWidth:1,
                                borderColor:'rgba(30,144,25,0.5)',
                                shadowBlur:{
