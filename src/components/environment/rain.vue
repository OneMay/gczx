<template>
    <div class="data">
        <div id="rainfall" :style="{width:'1200px',height:'400px'}"></div>
    ...
    export default {
        ...
        getData(dates,n){
            ...
            if(n==7||n==30){
                ...
                .then(res=>{
                    ...
                    this.getNot='';
                    this.option.legend.data=['最高降雨量','平均降雨量','最低降雨量']
                    this.option.series=[ {
                            name:'最高降雨量',
                            type:'line',
                            data:MaxDatas,
        ...
        mounted() {  
            this.$nextTick(function() {  
                setTimeout(this.drawGraph('rainfall'),1000);
            })  
        }
    }
</script>
